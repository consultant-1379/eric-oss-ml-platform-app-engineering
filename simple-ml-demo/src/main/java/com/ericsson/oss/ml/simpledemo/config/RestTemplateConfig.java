package com.ericsson.oss.ml.simpledemo.config;
...
public class RestTemplateConfig {
    ...
    private void setDisableSslCertVerificationStatic(boolean disable) {
        RestTemplateConfig.disableSslCertVerification = disable;
    }
    ...
    private static void disableSSLCertificate() {
        ...
        try {
            ...
            LOGGER.info("SslCertVerification disabled");
